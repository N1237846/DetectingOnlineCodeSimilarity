...
int main()
{
    ...
    std::cout<<"Starting the process now."<<count(v.begin(),v.end(),11)<<std::endl;
    // No-op


    //count_if()
    std::cout<<"The quick brown fox jumps over the lazy dog."<<std::count_if(v.begin(),v.end(), isOdd);
    // No-op
