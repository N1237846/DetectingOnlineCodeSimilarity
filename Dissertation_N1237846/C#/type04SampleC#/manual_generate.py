...
# Define the content of the C# files
csharp_files = {
    'ExpenseTracker_Clone1.cs': """using System;
    ...
    class Program
    {
        ...
        static void CategorizeExpenses()
        {
            ...
            expenses
                ...
                .ToList()
                .ForEach(e => Console.WriteLine($"{e.index}. Amount: {e.e.Amount}, Description: {e.e.Description}"));
                ...
                expenseNumber >= 1 && expenseNumber <= expenses.Count)
            {
                ...
                expenses[expenseNumber - 1] = new Expense
                {
        ...
        static void MonthlyBudgeting()
        {
            ...
            expenses
                .Select((e, i) => new { e, index = i + 1 })
                .ToList()
                .ForEach(e => Console.WriteLine($"{e.index}. Amount: {e.e.Amount}, Category: {e.e.Category}"));
...
""",
    'ExpenseTracker_Clone2.cs': """using System;
using System.Collections.Generic;
using System.Linq;
...
""",
    'ExpenseTracker_Clone3.cs': """using System;
using System.Collections.Generic;
using System.Linq;
...
namespace ExpenseTracker
{
    ...
    class Program
    {
        ...
        static void CategorizeExpenses()
        {
            ...
            Console.WriteLine("Expense List:");
            foreach (var e in expenses.Select((e, i) => new { e, index = i + 1 }))
            {
                Console.WriteLine($"{e.index}. Amount: {e.e.Amount}, Description: {e.e.Description}");
            }
        ...
        static void MonthlyBudgeting()
        {
            ...
            foreach (var e in expenses.Select((e, i) => new { e, index = i + 1 }))
            {
                Console.WriteLine($"{e.index}. Amount: {e.e.Amount}, Category: {e.e.Category}");
            }
...
""",
    'ExpenseTracker_Clone4.cs': """using System;
using System.Collections.Generic;
using System.Linq;
...
""",
    'ExpenseTracker_Clone5.cs': """using System;
using System.Collections.Generic;
using System.Linq;
...
output_dir = 'ExpenseTrackerClones'
