...
def create_csharp_clones(source_folder, target_folder, clone_prefix="Clone_"):
    """
    ...
    # List all C# files in the source folder (.cs)
    cs_files = [f for f in os.listdir(source_folder) if f.endswith('.cs')]
...
target_folder = 'type01SampleC#'

create_csharp_clones(source_folder, target_folder)
