/* Accept a binary expression from user as cmd argument and evaluate it using a functional interface. */
...
class Prog65
{
    public static void main(String[] args)
    {
        try
        {
            ...
            BiFunction<Double, Double, Double> operation = getOperation(ch);
    ...
    static BiFunction<Double, Double, Double> getOperation(char operator)
    {
