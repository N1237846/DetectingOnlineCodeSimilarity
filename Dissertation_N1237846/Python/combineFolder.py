...
def copy_python_scripts(src_folder1, src_folder2, dest_folder):
    ...
    # Copy .py files from the first source folder without suffix
    copy_files(src_folder1)
    # Copy .py files from the second source folder with a suffix
    copy_files(src_folder2, suffix='from_src2')

# Example usage
src_folder1 = 'python_scripts_dataset'
src_folder2 = 'type04SamplePython'
dest_folder = 'Type04CombinePythonDataset'
